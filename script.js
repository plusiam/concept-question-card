...
function renderCluster(cluster) {
  ...
  return `
    <div class="seed-cluster" data-cluster="${cluster.id}">
      ...
      ${cluster.title.trim()
        ? ''
        : '<div class="seed-cluster-hint">💡 비슷한 단어들을 아우르는 개념어를 한 단어로 붙여 보세요. 2단계에서 이 개념어가 어떤 명시된 개념과 이어지는지 살펴봐요.</div>'}
...
const STEP_HELP = {
  ...
  1: '궁금한 점을 질문으로 써요. <strong>질문 시작어 비계</strong>의 개념을 누르면 시작어가 나와 질문 만들기를 도와줘요. 만든 질문을 7개 명시된 개념 가운데 알맞은 곳으로 끌어다 분류해요. (질문 하나당 최대 3개, 질문 글을 누르면 고칠 수 있어요.)',
